...
// restrorent cards
const RestrountComponent = () => {
  return(
    <div className="card-container">
      <img src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/b1h0agx8ysx7w6ybrygc" alt="food-pic" />
      <h4 >Restaurent Name</h4>
      <h5>Quizines, Quizines2</h5>
      <h6>4.5 Stars</h6>
    </div>
  );
};
